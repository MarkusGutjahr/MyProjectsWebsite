                ...
                <div className="header-right">
                    ...
                    <div ref={loginRef}>
                        <div className="menu-icon" onClick={toggleLogin}>
                            ...
                            */}
                            <svg width="2.5vw" height="5vh" viewBox="0 0 41 44" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M31.5 13.5C31.5 19.5751 26.5751 24.5 20.5 24.5C14.4249 24.5 9.5 19.5751 9.5 13.5C9.5 7.42487 14.4249 2.5 20.5 2.5C26.5751 2.5 31.5 7.42487 31.5 13.5Z"
                                    stroke="white" stroke-width="5"/>
                                <path d="M38 44C38 34.0589 30.165 26 20.5 26C10.835 26 3 34.0589 3 44" stroke="white"
                                      stroke-width="5"/>
                            </svg>
